...
MainWindow::MainWindow(QWidget *parent)
    : QMainWindow(parent), client(new Client("FR-123456789", "Nonis", "Mric", "0612345678")),
...
void MainWindow::onLoginClicked()
{
    ...
    if (cin == client->getCIN() && password == "password")
...
void MainWindow::onTransferClicked()
{
    ...
    {
        double amount = QInputDialog::getDouble(this, "Virement", "Entrez le montant à transférer :",0, 0, 10000, 2, &ok);
        if (ok && amount > 0)
        {
